...
TEST_CASE( "DLinkedList<int>[5]: add/removeX/indexOf/contains") {
    DLinkedList<int> list;
    REQUIRE( list.size() == 0 );
...
TEST_CASE( "DLinkedList<int>[6]: query info") {
    DLinkedList<int> list;
    REQUIRE( list.empty() == true );
    int size = 10;
    for(int idx=0; idx < size; idx++){
...
TEST_CASE( "DLinkedList<int>[7]: using iterator") {
    DLinkedList<int> list;
    REQUIRE( list.empty() == true );
    int size = 10;
    for(int idx=0; idx < size; idx++){
...
TEST_CASE( "DLinkedList<int>[8]: using BWDIterator") {
    DLinkedList<int> list;
    REQUIRE( list.empty() == true );
    int size = 10;
    for(int idx=0; idx < size; idx++){
    ...
    SUBCASE("Iteration with for-loop"){
        ...
        int v = 9;
        for(it = list.bbegin(); it != list.bend(); it--){
            int value = *it;
            REQUIRE( value == v );
            v -= 1;
        }
    ...
    SUBCASE("Iteration with for-loop: for removing data"){
        ...
        int expvalues[] = {8,6,4,2,0};
        int idx = 0;
        for(it = list.bbegin(); it != list.bend(); it--){
            REQUIRE( *it == expvalues[idx++]); 
        }
    }
    SUBCASE("Iteration with while"){
        DLinkedList<int>::BWDIterator it = list.bbegin();
        int v = 9;
        while(it != list.bend()){
            int value = *it;
            REQUIRE( value == v );
